...
void buscarElemento(Frutas* vetor, int n_elementos, string& ordenadoPor){
    ...
    cout << "1. ID (requer ordenacao por ID)" << endl;
    cout << "2. Nome (requer ordenacao por Nome)" << endl;
    cout << "Opcao: ";
    cin >> opcaoBusca;
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    int indice = -1;
    if (opcaoBusca == 1){
        if (ordenadoPor != "id"){
            cout << "Erro: Os dados nao estao ordenados por ID. Use a Opcao 5." << endl;
            return;
        }
        int idBusca;
        ...
        if (ordenadoPor != "nome"){
            cout << "Erro: Os dados nao estao ordenados por Nome. Use a Opcao 5." << endl;
            return;
        }
        string nomeBusca;
        ...
        cout << "Opcao de busca invalida." << endl;
        return;
    }
